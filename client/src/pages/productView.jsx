    ...
    <button className="absolute top-10 right-10 transform translate-x-1/2 -translate-y-1/2 bg-green-500 rounded-full w-12 h-12 flex items-center justify-center text-white font-bold text-xl">
      3D
        ...
        <div className='flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6'>
            <h1 className="text-lg lg:text-xl font-semibold text-gray-900 ">Men black shirt</h1>
            <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">outfit</h1>
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="opacity-50 text-sm">2433 Ratings</p>
            <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">4353 Reviews</p>
               </div>
            </div>
