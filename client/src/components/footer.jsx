...
export default function footer() {
  return (
    <div className=" bg-slate-900">
      <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 border-t-2 py-12 ">
        <div className="flex flex-col items-center justify-center">
          <div className=" text-3xl font-bold text-orange-600">Envough</div>
          <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
            <p className="hover:text-orange-500 text-base cursor-pointer leading-4 text-gray-200">
              About
            </p>
            <p className="hover:text-orange-500 text-base cursor-pointer leading-4 text-gray-200">
              Contact us
          ...
          <div className="flex items-center gap-x-8 mt-6">
            <div className="cursor-pointer">
              <svg
                className="fill-current text-gray-300 hover:text-orange-500"
                width="22"
                height="22"
                viewBox="0 0 22 22"
                fill="none"
          ...
          <div className="flex items-center mt-6">
            <p className="text-base leading-4 text-gray-300">
              2024 <span className="font-semibold">Envough</span>
            </p>
